...
![SNI_Summary_With_SNI](./SNI_Summary_With_SNI.png)

![SNI_Details_With_SNI](./SNI_Details_With_SNI.png)

## 6.2 Example scan result for a site that serves all HTTPS requests
![SNI_Summary_Without_SNI](./SNI_Summary_Without_SNI.png)

![SNI_Details_Without_SNI](./SNI_Details_Without_SNI.png)
