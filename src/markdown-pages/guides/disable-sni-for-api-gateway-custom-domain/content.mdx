...
<GatsbyImage alt='SNI_Summary_With_SNI.png' image={getImage(props.data.mdx.frontmatter.embeddedImagesLocal[0])} />

<br/>

<GatsbyImage alt='SNI_Details_With_SNI.png' image={getImage(props.data.mdx.frontmatter.embeddedImagesLocal[1])} />

## 6.2 Example scan result for a site that serves all HTTPS requests

<GatsbyImage alt='SNI_Summary_Without_SNI.png' image={getImage(props.data.mdx.frontmatter.embeddedImagesLocal[2])} />

<br/>

<GatsbyImage alt='SNI_Details_Without_SNI.png' image={getImage(props.data.mdx.frontmatter.embeddedImagesLocal[3])} />
